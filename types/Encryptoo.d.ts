...
export function encryptBody<T>(body: Decrypted<T>, serverPublicKey: string): Promise<Encrypted<T>>;
export function decryptBody<T>(body: Encrypted<T>, serverPublicKey: string): Promise<Decrypted<T>>;
